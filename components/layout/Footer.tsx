...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/rinilkunhiraman',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/rinilkunhiraman',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/rinilkunhiraman',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:contactme.izbf7@passinbox.com',
      icon: (
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Rinil Kunhiraman</h3>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-center">
                ...
                <span className="text-sm">contactme.izbf7@passinbox.com</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} Rinil Kunhiraman. All rights reserved.
          </div>
